...
export const ScriptStore: Script[] = [
    ...
    {name: 'jquery', src: './assets/assetspuebla/js/jquery-1.12.4.js'}, 
    {name: 'popper', src: './assets/assetspuebla/libs/popper/popper.js'}, 
    {name: 'bootstrap', src: './assets/assetspuebla/libs/bootstrap/js/bootstrap.min.js'}, 
    {name: 'slick', src: './assets/assetspuebla/libs/slick/slick.min.js'}, 
    {name: 'jquery-zoom', src: './assets/assetspuebla/libs/slick/jquery.zoom.min.js'}, 
    {name: 'isotope', src: './assets/assetspuebla/libs/isotope/isotope.pkgd.min.js'}, 
